...
<div id="container">
  ...
  <div id="left_column">
    <div class="left_column_boxes">
      ...
      <div id="navcontainer">
        <ul id="navlist">
          <li id="active"><a href="http://all-free-download.com/free-website-templates/" id="current">Member</a></li>
          <li><a href="http://all-free-download.com/free-website-templates/">Books</a></li>
          <li><a href="http://all-free-download.com/free-website-templates/">Member Login</a></li>
          ...
          <li><a href="http://all-free-download.com/free-website-templates/">About Us </a></li>
           <li><a href="http://all-free-download.com/free-website-templates/">Feedback </a></li>
        </ul>
      </div>
    </div>
    <div class="left_column_boxes">
