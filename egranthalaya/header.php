        ...
        <div id="box2">
            ...
            <div id="box3">
                ...
                <table style="border:1px solid blue;margin-left:70px;margin-top:5px">
                              <tr>
                                  <th style="padding:5px;width:156px;color:white;background-color:rgb(101,118,235)">
                                      <a href="http://localhost/template1/incharge/login.php">Incharge Login</a>
                                  </th>
                                  <th style="padding:5px;width:156px;color:white;background-color:rgb(101,118,235)">
                                      <a href="http://localhost/template1/books.php"> Books<a
                                  </th>
                                  <th style="padding:5px;width:156px;color:white;background-color:rgb(101,118,235)">
                                      <a href="http://localhost/template1/member_template/member/member1_login.php">Member Login</a>
                                  </th>
                                  <th style="padding:5px;width:156px;color:white;background-color:rgb(101,118,235)">
                                      <a href="http://localhost/template1/index1.php">Home</a>
                                  </th>
                                  <th style="padding:5px;width:156px;color:white;background-color:rgb(101,118,235)">
                                      <a href="#"> About Us</a>
                                  </th>
                                  <th style="padding:5px;width:155px;color:white;background-color:rgb(101,118,235)">
                                      <a href="http://localhost/template1/feedback_form.php">Feedback</a>
                                  </th>
